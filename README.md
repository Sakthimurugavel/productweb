        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <p>Buy Fancy items and Cosmetics online for Women from <span style="background-color:rgb(153, 0, 255)">Luffy Productions</span>
                ...
                Copyright &copy;2023 Developed by Eiichiro Oda</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/oda.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .manph1{
            background-image: url(/static/images/kishimoto.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .manph2{
            background-image: url(/static/images/titekubo.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/images/yuukitabata.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/akari.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/Boichi.webp);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Eiichiro Oda</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Masashi Kishimoto</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Emma Mayor</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Yuuki Tabata</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Akari Kito</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>Boichi</h2></b></p></div><br>
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <ul>
                        <li><b>Landline:</b> 4828644254</li>
                        <li><b>Mobile</b>: 85468246</li>
                        <li><b>Facebook</b>: fb/Sungodluffy</li>
                        <li><b>Email Id:</b>SungodMd@fancyuniv.com</li>
                    </ul>
